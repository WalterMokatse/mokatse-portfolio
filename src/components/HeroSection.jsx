  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-4 md:px-12 bg-center bg-cover bg-fixed py-24 md:py-0"
      ...
      <div className="text-center text-white max-w-4xl mx-auto relative z-10">
        ...
        <div className="flex items-center justify-center gap-2 mb-6 opacity-0 animate-fade-in">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16 opacity-0 animate-fade-in-delayed-3">
          ...
          <button className="group border-2 border-white/30 text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 hover:bg-white/10 hover:border-white/50 hover:scale-105 transform">
            View My Work
          </button>
        </div>
      </div>
